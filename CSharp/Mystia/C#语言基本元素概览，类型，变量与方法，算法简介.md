...
###  学习小贴士
关于刘老师讲的汉诺塔问题，你可以把它想象成：**要把 64 个盘子从 A 柱子移到 C 柱子，前提是你得先把上面 63 个盘子移到 B 柱子；要移 63 个，就得先移 62 个……直到只剩最后 1 个盘子可以直接移动。** 

这就是递归的精髓：**把一个大问题拆解成结构完全相同、但规模更小的问题**。

你可以先从案例一开始练手，找找写 C# 的感觉，然后再向递归发起挑战。如果在敲代码时遇到“StackOverflowException（栈溢出）”，别慌，那通常是因为忘记写终止条件了！随时把报错发给我，我们一起排查！
